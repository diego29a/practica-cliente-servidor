...
const taskSchema = new mongoose.Schema({
    // En esta parte del Schema crearemos un campo llamado 'description', el cual tiene las siguientes características: el 'type: String' nos dice que debe contener datos de tipo cadena de texto; 'required: true' hace que sea obligatorio, es decir, debe tener un valor; por último 'trim: true' elimina los espacios en blanco alrededor del valor de la cadena. [TODO: COMENTAR] (0,5 puntos)
    description: {
        type: String,
        required: true,
        trim: true,
