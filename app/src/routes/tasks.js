...
const taskRoutes = async (server, options) => {
    ...
    server.post("/", async (request, reply) => {
        // TODO: COMENTAR!!! (0,5 puntos) qué valdría newTask si fuera const newTask = new Task() Utilizaría los valores por defecto del modelo de datos 'Task', del archivo 'task.model.js'.
